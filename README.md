# Alyra Project #2 : Unit tests
## Description
This is the second project from the Alyra training for blockchain developer.    
This consists in covering the smart contract Voting.sol with unit tests.
